 ...
 *
 * Доступные отношения:
 * @property PressCategoryObjects $catLink Связка с категориями.
 * @property FilesLink               $fileLink
 *
 * @package    converter
 * @subpackage pressobjects
 * @author     rudnik <nnrudakov@gmail.com>
 * @copyright  2014
 */
class PressObjects extends KitObjects
{
    /**
     * Модуль.
     *
    ...
    {
        return [
            'catLink'  => [self::BELONGS_TO, 'PressCategoryObjects', 'object_id'],
