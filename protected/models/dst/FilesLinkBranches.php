 ...
 *
 * Доступные отношения:
 * @property FilesBranches $file Файл.
 *
 * @package    converter
 * @subpackage fileslinkbranches
 * @author     rudnik <nnrudakov@gmail.com>
 * @copyright  2014
 */
class FilesLinkBranches extends DestinationBranchModel
{
    /**
    ...
    {
        return [
            'file' => [self::BELONGS_TO, 'FilesBranches', 'file_id']
        ];
    }
