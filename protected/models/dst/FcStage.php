...
class FcStage extends DestinationModel
{
    ...
    public function rules()
    {
        return [
            ...
            [
                'group0placefrom, group0placeto, group1placefrom, group1placeto, group2placefrom, group2placeto, group3placefrom, group3placeto, group4placefrom, group4placeto',
                'numerical',
                'integerOnly' => true,
                'allowEmpty'  => true
            ],
            [
                'title, fullTitle, group0title, group1title, group2title, group3title, group4title',
                'length',
                'max' => 128
            ],
            ['style', 'length', 'max' => 16],
            ['reglament', 'safe'],
            [
                'id, championship_id, title, fullTitle, style, reglament, group0title, group0placefrom, group0placeto, group1title, group1placefrom, group1placeto, group2title, group2placefrom, group2placeto, group3title, group3placefrom, group3placeto, group4title, group4placefrom, group4placeto',
                'safe',
                'on' => 'search'
            ],
        ];
